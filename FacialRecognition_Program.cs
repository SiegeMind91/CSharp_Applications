...
using SixLabors.ImageSharp.Processing.PixelFormats;

namespace FaceDetect
{
    class Program
    {
        private static string msg = "Please provide the API Key as the first command-line parameter, and the file name as the second paramter";
        ...
        static void Main(string[] args)
        {
            ...
            //Open the file with the default app for files of that type (.JPEG in this case)
        ...
        {
            using (var fs = new File.Create(outputfilename))
            {
                img.SaveAsJpeg(fs);
            }
        }
        ...
        {
            var request = WebRequest.CreateHttp(request);
